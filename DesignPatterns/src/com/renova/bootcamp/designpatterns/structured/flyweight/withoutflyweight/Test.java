...
public class Test {
	public static void main(String[] args) {
		...
		// CoffeShop' un take order metodu bizim için bir order oluşturacak
		// burada oluşturulan bütün order' lardaki nesneler farklı nesne olarak oluşturulup list' e atılacak
		// yani her sipariş için bir tane Coffee nesnesi oluşturulacak
